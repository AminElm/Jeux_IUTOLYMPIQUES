...
public class FenetreSupprimerEpreuve extends BorderPane {
        /**
     * le titre
     */
    private Label titre;
    ...
    private ComboBox<Epreuve> comboEpreuve;
  
    private FenetreAdministrateur appAdm;


    public FenetreSupprimerEpreuve(Main app){
        super();
        this.app = app;
...
//     }
    ...
    public void viderFiche(){
        this.comboEpreuve.setValue(null); 
    }
    ...
    public GridPane modeAjouterAthlete(){
        ...
        labelNationalite = new Label("Choisir une épreuve:");
        comboEpreuve = new ComboBox<>();
        comboEpreuve.setPadding(new Insets(0,0,0,125));
        grid.add(labelNationalite, 0, 3); 
        grid.add(comboEpreuve, 1, 3); 
        ...
        this.boutonSupprimerAthlete = new Button("Supprimer l'épreuve",valide);
        ...
        boutonSupprimerAthlete.setOnAction(new ControleurSupprimerEpreuve(this));
    ...
    */
    ...
    public Alert popEpreuveVide() {
        return new Alert(Alert.AlertType.INFORMATION, "L'épreuve est vide !");
        
    }


    public Alert popEpreuveSupprimer() {
        Alert alert = new Alert(Alert.AlertType.INFORMATION, "L'épreuve à bien été supprimé !");
        viderFiche();
        return alert;        
    }
